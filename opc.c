 ...
 *
 * $Log$
 * Revision 1.1  2004/10/28 21:19:16  gregb
 * Initial revision
 *
 ************************************************************************/
...
#define SWIG_init    initopc

#define SWIG_name    "opc"
...
extern "C" 
#endif
SWIGEXPORT(void,initopc)() {
	 PyObject *m, *d;
	 SWIG_globals = SWIG_newvarlink();
	 m = Py_InitModule("opc", opcMethods);
